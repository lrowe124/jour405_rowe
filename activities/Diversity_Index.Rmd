...
**ANSWER HERE**
Balitimore city seems to be the most diverse, followed by Germantown and then Columbia based off the "TwoPlusRaces" categories.
...
**ANSWER HERE**
Summerfield, Lakeshore and Hillcrest Heights have the highest race probability. They are at .871, .867, and .866 respectively.
...
**ANSWER HERE**
Chillum (.506), East Riverside (.510) and Wheaton (.513) have the three lowest hispanic probabilities. 
...
**ANSWER HERE**
The top 3 cities with the highest diversity index are Langley Park (97.1), Wheaton (90.8) and Adelphi (90.04). Both Langley Park and Adelphi are in Prince George's County and Wheaton is in Montgomery County
...
**ANSWER HERE**
"What makes Wheaton the most diverse city in Maryland?"

Recent data analysis showed that Wheaton had the highest rate of diversity in the state, further investigation revealed why.

This story could take a look at the concentration of diverse communities in the city, and maybe even create maps and other data visualizers to show this distribution. Some people to interview could be representatives from each community, historical societies and other resources that can provide historical context and city officials. I could ask people if they feel like their experiences in the city match with how diverse our analysis claims it is, as well as a few questions about how the man identities in the city formed over time.