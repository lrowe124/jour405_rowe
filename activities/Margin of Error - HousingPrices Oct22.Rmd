...
For the first survey, I would argue that the headline is not statistically justified because the margin of error is great enough for some of its lower levels to fall below 50%. For the last 2, the headline would be justified because all of their values, accounting for even the lowest levels of the margin of error, fall above 50%. 
...
Analysis of recent data suggests that the price of houses will increase following the introduction of a new transit line. This analysis of previous averages, listed at $285,000, compared with newer averages show an increase of nearly $20,000, or 6.8%. This could be due to increased access to transit, which typically raises property values. 