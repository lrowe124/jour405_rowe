...
The FARMS percentage and math test scores are very weakly positively correlated.
...
**WRITE ANSWER HERE**
The model suggests that the correlation is not significant, as the p-value of .1225 is greater than .05. Despite this, there is still a correlation as shown by the scatter plot.
...
**WRITE YOUR ANSWER HERE**
Whitemarsh Elementary School has the highest residual of -45.828, which means that the actual score was 45.828 less than what was predicted. Rydal West School also had a very high residual at -38.928.
...
**WRITE YOUR ANSWER HERE**
Using this model, it is clear that the correlation between FARMS size and standardized math test performance is veyr weak. I don't think that the board member's conclusions can be supported using this methodology. A story pitch about this would probably focus on how they were wrong in their analysis, and perhaps suggest other, stronger correlations to math test performance.