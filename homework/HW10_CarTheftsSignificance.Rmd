...
**WRITE ANSWERS HERE:**
There is a general decreasing trend over in the data. Despite periods of rising crime, the rate continues to decrease overall. 
...
The 95% confidence interval means that the mean would be consistent in 95 of 100 samples.

- What figure(s) accurately reflects the number of car thefts in a typical month? **WRITE ANSWER HERE:**
The number of car thefts in a typical month is 460.4.
...
We cannot reject the null hypothesis because the p-value of .1791 is greater than the alpha of .05. This means that the difference between the two periods is not statistically significant.
...
My new headline would read "Despite recent trends, car theft rates expected to stay consistent." I would tell my editor that analysis of the data showed that the recent decrease is not significant enough to suggest that this decrease will continue. I would expect them to ask me how I know this, in which I would show them the general trend in decreases before showing how the t-test suggests that it is still not significant enough.
