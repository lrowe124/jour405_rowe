...
Education levels in sur ey sampels may differ from the general population because the likelihood that someon would pursue higher education depends on a variety of factors. Location is a strong indicator, and so if a sample is taken from an affluent area, the levle of education may be higher. 
...
**Write your ANSWER HERE**
"People with a high school education or less are the least likely to vote"
...
The percentages did not change too much after applying weights. The group that showed the biggest change were people with a high school education or less, as those who said yes decreased by about 3% and those who said no increased by about 1.5%.
...
The weighted results are considered more accurate because they acknowledge the relative sizes of the samples and work to count each person the same.
...
**Write your ANSWER HERE**
The group with a hgih school education or less showed the largest difference betweeen weighted and unweighted results.
...
**Write your ANSWER HERE**
Weighting allows for journalists to understand just how representative of a population the polling results they are using are.

2. How might the differences between weighted and unweighted results affect how you would report on this data?

**Write your ANSWER HERE**
The weighting would not affect my coverage of the "yes" and "unsure" answers much, as those stayed pretty similar when the results were weighted. It would change how I reported on the "no" response, as the unweighted result is higher than the weighted result. 
...
**Write your ANSWER HERE**
I would want to know where the data was taken from, and the demographics of that area. I would also want to know the total population.
